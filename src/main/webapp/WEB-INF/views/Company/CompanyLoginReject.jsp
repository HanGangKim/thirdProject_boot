			...
			<div class="container pt-12 pb-lg-16 col-11 pb-9">
				<div class="row pt-lg-5 pb-5 justify-content-center text-center">
					<div class="col-xl-4">
						...
						<h4 class="display-4 mb-3">Sign Up Fail ...</h4>
						<p class="mb-2 lead mx-auto">죄송합니다. 회원가입 양식을 다시 확인해 주세요.</p>
						<p class="mb-5 lead mx-auto fs-6">문의사항 : 02-1234-5678</p>
						<div class="mx-auto">
							<a href="/company/Agreement.do" class="btn btn-primary d-grid">Again Sign Up</a>
						</div>
					</div>
				</div>
			</div>
