						...
						<div class="nav-item me-3">
							<c:choose>
								<c:when test="${sessionScope.userId == null}">
									<a href="/Information.do" class="lh-1 position-relative text-light">Hello :)</a>
								</c:when>
								<c:when test="${sessionScope.userId != null}">
									<a href="/Information.do" class="lh-1 position-relative text-light">Welcome !</a>
								</c:when>
							</c:choose>
						</div>
					...
					<div class="navbar-collapse collapse" id="mainNavbarTheme" style="">
						<ul class="navbar-nav mx-auto">
							...
							<li class="nav-item position-lg-static me-lg-3"><a
								class="nav-link nav-over active" href="/start/NoneMemberMain.do" role="button"
					...
					<!--전시회 검색 시작  -->
						...
						<div class="d-flex align-items-center">
							<div class="d-flex flex-grow-1 align-items-center">
								...
								name = "exhibition_title"  id="searchInputBox" onkeydown="characterCheck()"  onkeyup="characterCheck()"
